...
const Login = () => {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    setTimeout(() => {
      ...
      // Navigate based on role (mock: admin goes to dashboard, client goes to client home)
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-sidebar-foreground">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-sidebar-foreground/70">Race Event Management</p>
            </div>
          </div>
          ...
          <div className="space-y-6 max-w-md">
            ...
            <div className="flex gap-8 pt-6">
              <div>
                ...
                <div className="text-sm text-sidebar-foreground/60">Events Managed</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-primary">50K+</div>
                <div className="text-sm text-sidebar-foreground/60">Participants</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-primary">99.9%</div>
                <div className="text-sm text-sidebar-foreground/60">Accuracy</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Race Event Management</p>
            </div>
          </div>

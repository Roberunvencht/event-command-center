...
export default function Leaderboard() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Leaderboard & Results</h1>
        <p className="text-muted-foreground mt-2">Track your performance and rankings</p>
      </div>
              ...
              <Table>
                ...
                <TableBody>
                  {overallLeaderboard.map((runner) => (
                    <TableRow
                      key={runner.rank}
                      className={runner.isUser ? "bg-primary/5 border-l-4 border-l-primary" : ""}
                    >
                      <TableCell>

...
export default function Results() {
  const fullMarathonResults = [
    { position: 1, bib: "001", name: "Erik Larsson", team: "None", time: "2:15:23", icon: Trophy },
    { position: 2, bib: "042", name: "John Smith", team: "Team A", time: "2:18:45", icon: Medal },
    { position: 3, bib: "103", name: "Jose Reyes", team: "Team B", time: "2:22:17", icon: Award },
    { position: 4, bib: "087", name: "David Chen", team: "None", time: "2:28:09" },
    { position: 5, bib: "156", name: "Sarah Miller", team: "Team A", time: "2:31:54" },
  ];

  const halfMarathonResults = [
    { position: 1, bib: "234", name: "Emma Wilson", team: "Team C", time: "1:12:34", icon: Trophy },
    { position: 2, bib: "189", name: "Mike Johnson", team: "None", time: "1:15:21", icon: Medal },
    { position: 3, bib: "267", name: "Lisa Anderson", team: "Team D", time: "1:18:45", icon: Award },
  ];
        ...
        {results.map((result) => {
          ...
          return (
            <TableRow key={result.position} className="hover:bg-muted/30">
              ...
              <TableCell className="text-muted-foreground">{result.team}</TableCell>
              <TableCell className="font-mono font-medium text-primary">{result.time}</TableCell>
              <TableCell>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">View race results and leaderboards</p>
        </div>

				...
				<CardContent className='p-6'>
					<div className='flex flex-col sm:flex-row gap-4 mb-6'>
						<div className='relative flex-1'>
							...
							<Input
								placeholder='Search by name, bib number, team...'
								className='pl-9'
							/>
						</div>
						<Button variant='outline' className='gap-2'>
